    ...
    <nav className="flex w-screen justify-between bg-gray-50 text-gray-600">
      <div className="w-full xl:px-12 py-6 px-5 flex space-x-12 items-center ">
        ...
        <ul className="hidden md:flex mx-auto px-5 font-semibold space-x-12">
          ...
          <li>
            <a className="hover:text-gray-900" to="/">
              Products
            </a>
          </li>
          <li>
        ...
        <div className="hidden xl:flex items-center text-gray-600 space-x-5 items-center">
          ...
          <a className="flex items-center hover:text-gray-900" to="/addtocart">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
      ...
      <a className="xl:hidden self-center mr-12 hover:text-gray-900" to="/">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
          fill="none"
...
//                     <button to="/login" className="-m-2 block p-2 font-medium text-gray-900">
//                       Sign in
//                     </button>
//                   </div>
//                   <div className="flow-root">
...
//                     <img
//                       src="https://images.app.goo.gl/YAfw4vXqfLusGbbr8"
//                       alt="Website_Logo"
...
//       <header className="relative bg-[#c2f0ff]">
