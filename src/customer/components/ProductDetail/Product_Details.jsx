      ...
      <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
        ...
        <div class="mt-3 flex select-none flex-wrap items-center gap-1">
          <label class="">
            ...
            <Link class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Powder</Link>
          </label>
          <label class="">
            <input type="radio" name="type" value="Whole Bean" class="peer sr-only" />
            <Link class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Whole Bean</Link>
          </label>
          <label class="">
            <input type="radio" name="type" value="Groud" class="peer sr-only" />
            <Link class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Groud</Link>
          </label>
        </div>
        ...
        <div class="mt-3 flex select-none flex-wrap items-center gap-1">
          <label class="">
            ...
            <button class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">4 Months</button>
          ...
          <label class="">
            ...
            <Link class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">8 Months</Link>
          ...
          <label class="">
            ...
            <Link class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">12 Months</Link>
